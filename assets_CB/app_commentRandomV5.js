...
app.controller('PostController', function($scope, $timeout, $interval, fileReader) {
        ...
        // V5 Added Script: Check if the comments count exceeds 100, and remove the oldest comments if necessary
        if ($scope.comments.length > 50) {
          $scope.comments.splice(50);
        }
        // V5 Added Script: End Here--------------->
